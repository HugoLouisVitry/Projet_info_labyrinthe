...
absolute_folder = '/home/hugo/Documents/Enac/Projet info programmes Oral/BDD_lab/random_entry/'
excel_folder = '/home/hugo/Documents/Enac/Projet info programmes Oral/Excel/'

for i in range(30,51) : 
    Maze_file= (absolute_folder+"{}x{}.txt").format(i,i) #penser à mettre le vrai chemin sur vos pc (ou se trouve database)
...
#    maze_converter.graphics(Graphic_maze)
    ...
    Chemin, Distance,history,Tm = dijkstra.dijkstra_mono(nodes)
    Chemin2, Distance2,history2,history2_reverse,h_total,Tb = dijkstra.dijkstra_double(nodes)
    Tbidi.append(Tb)
    Tmono.append(Tm)
...
fichier_excel_courbes.save(excel_folder+'fichier courbes.xls')
